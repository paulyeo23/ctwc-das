...
export const Navbar: React.FC = () => {
  return (
    <nav
      id="navBarSmartphone"
      className="navbar-smartphone smartphone-only fixed top-0 w-full bg-white shadow-md z-[101]"
    >
        ...
        <li className="nav-logo">
          ...
          >
            <img
              alt="CTWC DAS"
              src={ctwcDas}
              className="small-logo-img h-12 w-12 aspect-[1/1] align-middle border-none bg-slate-800"
              loading="lazy"
            />
          </a>
        </li>
