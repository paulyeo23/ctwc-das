export const Player2Score: React.FC = () => {
  return (
    <span className="results-right won flex-row-reverse text-right whitespace-nowrap overflow-hidden text-ellipsis flex-none flex-grow-0 w-[43%] flex font-bold relative text-green-600">
